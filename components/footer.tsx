  ...
  return (
    <footer className="relative z-10 bg-background border-t border-border/40 py-20 px-6 md:px-20 mt-auto">
      <div className="max-w-[1440px] mx-auto flex flex-col items-center gap-8 text-center">
        ...
        {/* Owner Profile (Clean Borderless Layout) */}
        <div className="flex items-center gap-3.5 w-fit max-w-[90vw] mx-auto text-left">
          <div className="w-11 h-11 rounded-full overflow-hidden bg-neutral-200 border border-border/40 flex-shrink-0">
            <img
              src="/owner.jpg"
              alt="Owner"
        ...
        {/* Legal Links (Below Socials, Above Copyright - Matched Size) */}
        <div className="flex flex-wrap justify-center gap-6 md:gap-8 font-sans text-sm tracking-wide text-secondary items-center pt-1">
          <Link href="/terms" className="hover:text-primary transition-colors duration-300 flex items-center gap-1.5 font-semibold">
            <FileText className="w-4 h-4 text-secondary/80" />
            <span>Ketentuan Layanan</span>
          </Link>
          <span className="text-secondary/30">•</span>
          <Link href="/privacy" className="hover:text-primary transition-colors duration-300 flex items-center gap-1.5 font-semibold">
            <ShieldCheck className="w-4 h-4 text-secondary/80" />
            <span>Kebijakan Privasi</span>
          </Link>
        </div>

        {/* Brand Tagline */}
        <p className="font-sans text-[10px] uppercase tracking-widest text-secondary mt-4">
